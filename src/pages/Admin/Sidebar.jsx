    ...
    <>
      <div className="w-[15%] bg-black text-white px-5">
          ...
          <ul className="space-y-10 mt-6">
              ...
              <li><Link to={"/admin/dashboard"} className="flex flex-col items-center justify-center gap-3"><span><LuGalleryHorizontalEnd className="text-white text-2xl" /></span><span className="text-xl">Gallery</span></Link></li>
